...
class Team(Base):
    ...
    __table_args__ = (
        Index("idx_teams_external_provider", "external_id", "provider", unique=True),
    )
...
class Player(Base):
    ...
    player_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    external_id: Mapped[str] = mapped_column(String(50), nullable=False)
    provider: Mapped[str] = mapped_column(String(30), nullable=False)
    team_id: Mapped[uuid4 | None] = mapped_column(Uuid, ForeignKey("teams.team_id"))
...
class Match(Base):
    ...
    match_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    external_id: Mapped[str] = mapped_column(String(50), nullable=False)
    provider: Mapped[str] = mapped_column(String(30), nullable=False)
    ...
    home_team_id: Mapped[uuid4 | None] = mapped_column(
        Uuid, ForeignKey("teams.team_id")
    )
    away_team_id: Mapped[uuid4 | None] = mapped_column(
        Uuid, ForeignKey("teams.team_id")
    )
...
class MatchEvent(Base):
    ...
    event_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    match_id: Mapped[uuid4] = mapped_column(
        Uuid, ForeignKey("matches.match_id"), nullable=False
    )
    event_type: Mapped[str] = mapped_column(String(40), nullable=False)
    minute: Mapped[int | None] = mapped_column(SmallInteger)
    second: Mapped[int | None] = mapped_column(SmallInteger)
    team_id: Mapped[uuid4 | None] = mapped_column(Uuid, ForeignKey("teams.team_id"))
    player_id: Mapped[uuid4 | None] = mapped_column(
        Uuid, ForeignKey("players.player_id")
    )
...
class OddsSnapshot(Base):
    ...
    snapshot_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    match_id: Mapped[uuid4] = mapped_column(
        Uuid, ForeignKey("matches.match_id"), nullable=False
...
class PlayerBiometric(Base):
    ...
    biometric_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    player_id: Mapped[uuid4] = mapped_column(
        Uuid, ForeignKey("players.player_id"), nullable=False
    )
...
class SentimentScore(Base):
    ...
    sentiment_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    entity_type: Mapped[str] = mapped_column(String(10), nullable=False)
    entity_id: Mapped[uuid4] = mapped_column(Uuid, nullable=False)
    source: Mapped[str] = mapped_column(String(30), nullable=False)
    ...
    __table_args__ = (
        Index("idx_sent_entity_time", "entity_type", "entity_id", "captured_at"),
    )
...
class FeatureStore(Base):
    ...
    feature_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    match_id: Mapped[uuid4] = mapped_column(
        Uuid, ForeignKey("matches.match_id"), nullable=False
...
class Prediction(Base):
    ...
    prediction_id: Mapped[uuid4] = mapped_column(
        Uuid, primary_key=True, default=uuid4
    )
    match_id: Mapped[uuid4] = mapped_column(
        Uuid, ForeignKey("matches.match_id"), nullable=False
